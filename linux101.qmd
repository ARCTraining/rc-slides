...
[_ ]{style="color: black"}[\@username]{style="color: #00FF00"} **→** [/folders]{style="color: #00FFFF"} [(main)]{style="color: #FF7F50"} [$]{style="color: grey"} [**this is the code you type**]{style="color: white"} [↵]{style="color: #DDA0DD"}
...
::: {style="font-size: 1.2em; text-align: left; background-color: black; color: white; font-family: monospace"}
 ...
 [_ ]{style="color: black"}[\@username]{style="color: #00FF00"} **→** [~]{style="color: #00FFFF"} [$ ▮]{style="color: white"}
:::
