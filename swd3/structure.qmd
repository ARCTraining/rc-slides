...
```{.bash}
# The most basic structure for a Python project should look like:
my-model
├── src
│   └── __init__.py
|   └── my_model.py
...
- Directory to group modules.
- For a folder with several modules to be recognized as a package it is necessary to include the file `__init__.py`
...
Template from [mkrapp github](https://github.com/mkrapp/cookiecutter-reproducible-science)
