...
## A Guide to delivering Presentations Using Quarto {.smaller}
...
(heart) no
```
- The `thumbsup` and `heart` emojis  are the first two emojis that are in the reaction list of Teams users by default.
...
- However, this use of `Forms` is being phased out in preference for a `Polls App`
  - The `Polls App` however, is not available in the University of Leeds Office 365 offerring
  - Collecting result from the Teams chat version is borked!
...
- [Example](https://forms.office.com/pages/designpagev2.aspx?lang=en-GB&origin=OfficeDotCom&route=Start&subpage=design&id=qO3qvR3IzkWGPlIypTW3yy7GBfs2qsFOjWB83KLaHnVUNzFZS1VCTENOVEJUMDdKVEEyNURDRlY2USQlQCN0PWcu)
  - Clicking here should take you to a form (the URL can be pasted into a Teams chat)
...
## Breaks, feedback and questions
- Please encourage interruptions especially for participants experience difficulty hearing or following the presentation...
- Periodically pause and ask if participants have any questions or want anything repeated...
- Ideally there should be at least:
  - A 5 minute break after 30 minutes (or before)
  - A 10 minute break after a further 30 minutes (or before)
  - A 5 minute break after a further 30 minutes (or before)
  - A longer break after a further 30 minutes (or before)
