...
- The `Polls App` however, is not available in te University of Leeds Office 365 offerring currently.
- It might be best to prepare some `Forms` forms in advance using the `Forms` in Office 365 (https://www.microsoft365.com/launch/forms).
  - Sharing then simply involves copying the URL and paste into the chat.
...
## Hackpads
- These are used as a place to add links to the slides and documentation and where participants can introduce themselves.
- Some of this could maybe be captured and used as easily using a `Forms` form.
...
## Getting Feedback
- At the end of the training it is good to encourage participants to provide honest feedback about presentations and the training so we can improve.
