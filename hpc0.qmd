...
![](assets/img/hpc0/training.svg)

## ARC/HPC Training Portfolio

<http://arc.leeds.ac.uk/training>

![](assets/img/hpc0/portfolio.svg)
...
## Logging in... {background-color="#bbe1f6"}

Using MobaXTerm

## What is BASH? {background-color="black"}

![](assets/img/hpc0/bash.png)

## What is a shell?

![](assets/img/hpc0/shell.svg)

## MobaXTerm {background-color="#bbe1f6"}

Launch...

## Filesystem basics

![](assets/img/hpc0/filesystem.svg)
...
![](assets/img/hpc0/filesystem-absolute.svg)

## Filesystem basics: relative path

![](assets/img/hpc0/filesystem-relative.svg)
