...
::: {.notes}
- Skipping/hiding slide until there is an updated graphic of what training we are delivering as training courses...
:::
...
- Attempt to use Forms form or Hackpad to get partipants to introduce themselves and why they want to use the HPC.
...
::: {.notes}
- "This slide shows the syllabus and what we plan to go through in the next 3 hours."
- "We'll aim to have 5 to 10 minute breaks roughly every 30 minutes."
:::
...
- Conduct a poll about what host Operating Systems participants expect to use to connect to the HPC.
:::
...
- Maybe conduct a poll on what types of connection participants expect to use to connect to the HPC.
:::
...
- "We will enter some commands after these next few slides..."
:::
...
- "The `...` shown in the output may be many more lines of output depending on what was listed."
...
- `echo` is a command that will send what comes after it to the Standard Output (`std.out`).
