...
- Please read the slide:
  - "We are developing and providing training in..."
:::
...
- "This is a lot to cover in 3 hours."
- "We'll aim to have 5 or 10 minute breaks roughly every 30 minutes."
- "Let's make headway and get through the first part before taking a short break..."
:::
...
::: {.notes}
- "For OSx, `terminal` is already a Linux command line interface program:"
