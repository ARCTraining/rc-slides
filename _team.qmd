...
- Click the `Team` link.
- In the `Slide View` Web browser window a new `Team Tab` should open showing the the `Research Computing Team Web Page`
- Find the `Team Tab` and scroll down to show the current team...
- Introduce yourself:
  - "My name is..."
...
- In the `Slide View` window a new `Website Tab` should have open.
- Find the `Website Tab` and scroll down the `Research Computing Website Home Page` pointing out some sections/features:
  - Documentation
  - Search
  - Contact Us
